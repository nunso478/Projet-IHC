...
class MyMini extends StatefulWidget {
  @override
  _MyMiniState createState() => _MyMiniState();
}

class _MyMiniState extends State<MyMini> with SingleTickerProviderStateMixin {
  int currentPage = 0;
